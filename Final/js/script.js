$(document).ready(function() {
  ...
  // ----- BG MUSIC -----
  {
    ...
    var misato = new Audio();
    misato.src = "audio/music/Misato.mp3";
    misato.loop = true;
  ...
  // ----- MUSIC ROOM -----
  {
    ...
    // --- good kaworu end ---
    {
      ...
      // --- Player goes home with Kaworu ---
      $("#toMEXT1").click(function() {
        $("#mExt1").show();
        $("#mGood9").hide();
      });

      $("#toMEXT2").click(function() {
        $("#mExt2").show();
        $("#mExt1").hide();
      });

      $("#toMEXT3").click(function() {
        $("#mExt3").show();
        $("#mExt2").hide();
      });

      $("#toMEXT4").click(function() {
        $("#mExt4").show();
        $("#mExt3").hide();
      });

      $("#toMEXT5").click(function() {
        $("#mExt5").show();
        $("#mExt4").hide();
      });

      $("#toMEXT6").click(function() {
        $("#mExt6").show();
        $("#mExt5").hide();
      });

      $("#toMEXT7").click(function() {
        $(".storyBG").css("background-image", "url(img/bg/apt_night.jpg)");
        $("#mExt7").show();
        $("#mExt6").hide();
      });

      $("#toMEXT8").click(function() {
        $("#mExt8").show();
        $("#mExt7").hide();
      });

      $("#toMEXT9").click(function() {
        $(".storyBG").css("background-image", "url(img/bg/gos2_home_entry-hall.jpg)");
        $("#mExt9").show();
        $("#mExt8").hide();
        em17.volume = 0;
        misato.volume = 1;
        misato.currentTime = 0;
      });

      $("#toMEXT10").click(function() {
        $("#mExt10").show();
        $("#mExt9").hide();
      });

      $("#toMEXT11").click(function() {
        $("#mExt11").show();
        $("#mExt10").hide();
      });

      $("#toMEXT12").click(function() {
        $("#mExt12").show();
        $("#mExt11").hide();
      });

      $("#toMEXT13").click(function() {
        $("#mExt13").show();
        $("#mExt12").hide();
      });

      $("#toMEXT14").click(function() {
        $("#mExt14").show();
        $("#mExt13").hide();
      });

      $("#toMEXT15").click(function() {
        $("#mExt15").show();
        $("#mExt14").hide();
      });

      $("#toMEXT16").click(function() {
        $(".storyBG").css("background-image", "url(img/bg/gos2_home_dining-room.jpg)");
        $("#mExt16").show();
        $("#mExt15").hide();
      });

      $("#toMEXT17").click(function() {
        $("#mExt17").show();
        $("#mExt16").hide();
      });

      $("#toMEXT18").click(function() {
        $("#mExt18").show();
        $("#mExt17").hide();
      });

      $("#toMEXT19").click(function() {
        $("#mExt19").show();
        $("#mExt18").hide();
      });

      $("#toMEXT20").click(function() {
        $("#mExt20").show();
        $("#mExt19").hide();
      });

      $("#toMEXT21").click(function() {
        $("#mExt21").show();
        $("#mExt20").hide();
      });

      $("#toMEXT22").click(function() {
        $("#mExt22").show();
        $("#mExt21").hide();
      });

      $("#toMEXT23").click(function() {
        $("#mExt23").show();
        $("#mExt22").hide();
      });
      ...
      $("#toMEXT25").click(function() {
        $("#mExt25").show();
        $("#mExt24").hide();
      });

      $("#toMEXT26").click(function() {
        $("#mExt26").show();
        $("#mExt25").hide();
      });

      $("#toMEXT27").click(function() {
        $("#mExt27").show();
        $("#mExt26").hide();
      });

      $("#toMEXT28").click(function() {
        $("#mExt28").show();
        $("#mExt27").hide();
      });

      $("#toMEXT29").click(function() {
        $("#mExt29").show();
        $("#mExt28").hide();
      });

      $("#toMEXT30").click(function() {
        $("#mExt30").show();
        $("#mExt29").hide();
      });

      $("#toMEXT31").click(function() {
        $("#mExt31").show();
        $("#mExt30").hide();
      });

      $("#toMEXT32").click(function() {
        $("#mExt32").show();
        $("#mExt31").hide();
      });

      $("#toMEXT33").click(function() {
        $("#mExt33").show();
        $("#mExt32").hide();
      });

      $("#toMEXT34").click(function() {
        $("#mExt34").show();
        $("#mExt33").hide();
      });

      $("#toMEXT35").click(function() {
        $("#mExt35").show();
        $("#mExt34").hide();
      });

      $("#toMEXT36").click(function() {
        $("#mExt36").show();
        $("#mExt35").hide();
      });

      $("#toMEXT37").click(function() {
        $("#mExt37").show();
        $("#mExt36").hide();
      });

      $("#toMEXT38").click(function() {
        $("#mExt38").show();
        $("#mExt37").hide();
      });

      $("#toMEXT39").click(function() {
        $("#mExt39").show();
        $("#mExt38").hide();
      });

      $("#toMEXT40").click(function() {
        $("#mExt40").show();
        $("#mExt39").hide();
      });

      $("#toMEXT41").click(function() {
        $("#mExt41").show();
        $("#mExt40").hide();
      });

      $("#toMEXT42").click(function() {
        $("#mExt42").show();
        $("#mExt41").hide();
      });

      $("#toMEXT43").click(function() {
        $("#mExt43").show();
        $("#mExt42").hide();
      });

      $("#toMEXT44").click(function() {
        $("#mExt44").show();
        $("#mExt43").hide();
      });

      $("#toMEXT45").click(function() {
        $(".storyBG").css("background-image", "url(img/bg/gos2_home_dining-room.jpg)");
        $("#mExt45").show();
        $("#mExt44").hide();
      });

      $("#toMEXT46").click(function() {
        $("#mExt46").show();
        $("#mExt45").hide();
      });
